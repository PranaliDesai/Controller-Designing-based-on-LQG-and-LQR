...
sys_c2 = ss(Ac,Bc,Cc,Dc,'statename',states,'inputname',inputs,'outputname',outputs); %creates statesspace model
t = 0:0.1:200;
f = 50*ones(size(t));
...
Dce = [0];
states = {'x' 'x_dot' 'theta' 'theta1_dot' 'theta2' 'theta2_dot' 'e1' 'e2' 'e3' 'e4' 'e5' 'e6'};
inputs = {'r'};
outputs = {'x'};
